...
class demto3d:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&DEMto3D')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'demto3d')
        self.toolbar.setObjectName(u'demto3d')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/demto3d/icons/demto3d.png'
        self.add_action(
            icon_path,
            text=self.tr(u'DEM 3D printing'),
            callback=self.run,
